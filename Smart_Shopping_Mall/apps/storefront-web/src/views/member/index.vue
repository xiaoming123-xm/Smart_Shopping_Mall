<template>
  <div class="member">
    ...
    <div class="stats">
      ...
      <div class="stat"><b>{{ paid }}</b><span>已完成</span></div>
...
const unpaid = computed(() => orderStore.orders.filter(o => o.payStatus === "待支付").length);
const paid = computed(() => orderStore.orders.filter(o => o.payStatus === "已支付").length);
const totalSpent = computed(() => orderStore.orders.filter(o => o.payStatus === "已支付").reduce((s, o) => s + o.amount, 0));
</script>
<style scoped>
