...
export function useDashboard() {
    ...
    const pendingOrders = ref([
        { time: "2026-01-06 11:32:14", no: "20260111...LKAGO", buyer: "程序员老罗", status: "已付款,待发货", product: "恋爱星球项链高级感粉钻小爱心...", qty: 1, price: "¥59.90" },
        { time: "2026-01-05 11:33:00", no: "20260111...NBYQ", buyer: "程序员老罗", status: "已付款,待发货", product: "芦荟水乳爽肤水男士女保湿补水...", qty: 1, price: "¥59.90" },
    ]);
    const lowStock = ref([
