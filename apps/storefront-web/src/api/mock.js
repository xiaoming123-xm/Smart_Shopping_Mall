function svgImage(title, bg, stroke, body) {
...
const bird01 = svgImage("真迹01", "#d7d3ca", "#333", `<path d="M205 235c45 12 68 52 96 80 66-58 120-86 164-64-30 45-57 82-75 133 40 13 67 33 91 58-68 8-119-3-168-29-41 37-97 45-154 20 40-21 61-49 71-87-40-27-64-62-25-111z"/>
...
const bird02 = svgImage("真迹02", "#d6d7d2", "#3a3a3a", `<path d="M166 354c72-58 152-70 236-26"/>
...
const bird03 = svgImage("真迹03", "#dad7ce", "#333", `<path d="M196 190c48 8 76 50 82 94"/>
...
const bird04 = svgImage("真迹04", "#d2d1cb", "#2f2f2f", `<path d="M190 255c82-22 155-9 220 40"/>
...
const bird05 = svgImage("真迹05", "#dedbd2", "#363636", `<path d="M162 248c56 16 93 45 111 87"/>
...
const shoe = svgImage("运动鞋", "#eef5f4", "#d63535", `<path d="M122 390c95 8 180-3 258-39 36 32 85 50 144 54 18 2 30 17 24 34-7 20-23 31-48 33H154c-47 0-69-23-32-82z"/>
   <path d="M207 334c42 22 86 28 132 17M250 307l36 33M298 292l42 39M363 288l40 37"/>`);
const sweater = svgImage("毛衣", "#f4f1ed", "#7b8ba8", `<path d="M240 142h160l58 74 68 23-48 107-53-17v176H215V329l-53 17-48-107 68-23 58-74z"/>
   <path d="M248 149c29 48 115 51 144 0M216 329h210M247 469h143"/>`);
const necklace = svgImage("项链", "#f7eee8", "#222", `<path d="M210 108c26 108 192 108 220 0"/>
