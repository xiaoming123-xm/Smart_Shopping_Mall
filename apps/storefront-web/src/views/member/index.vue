<template>
  <div class="member">
    ...
    <div class="stats">
      ...
      <div class="stat"><b>¥{{ totalSpent.toFixed(2) }}</b><span>累计消费</span></div>
    </div>
    <div class="menu">
      <router-link to="/order" class="mi">我的订单</router-link>
      <router-link to="/messages" class="mi">用户消息</router-link>
...
.avatar { width: 64px; height: 64px; border-radius: 50%; background: #f0f2f5; display: flex; align-items: center; justify-content: center; font-size: 20px; color: #2f95bd; font-weight: 700; }
